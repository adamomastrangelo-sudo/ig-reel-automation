...
- `quote.txt`, `author.txt`, `quote_y.txt`, `author_y.txt`, `caption.txt` — **non vanno modificati a mano**: vengono sovrascritti automaticamente a ogni esecuzione con l'aforisma/autore presi dal Google Sheet, già andato a capo e con le posizioni verticali calcolate per non sovrapporsi (vedi [`../README.md`](../README.md#coda-testi-google-sheet))
